...
/datum/martial_art/basic_anatomic
	name = "Basic Anatomic Martial Art"
	id = MARTIALART_ANATOMIC
	help_verb = /mob/living/carbon/human/proc/BAMA_help
	block_chance = 30
	smashes_tables = TRUE
...
/datum/martial_art/cqc/proc/Slam(mob/living/carbon/human/A, mob/living/carbon/human/D)
	var/def_check = D.getarmor(BODY_ZONE_CHEST, "melee") // a - user, d - target
	if(!can_use(A))
		return FALSE
	if(D.mobility_flags & MOBILITY_STAND)
		...
		D.apply_damage(8, BRUTE, blocked = def_check)
		D.Paralyze(30)
...
/datum/martial_art/cqc/proc/Kick(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(!D.stat || !D.IsParalyzed())
		...
		D.apply_damage(8, A.dna.species.attack_type, blocked = def_check)
